...
import { RiInstagramFill, RiLinkedinFill, RiMailCheckFill } from 'react-icons/ri';
...
const Contacts = () => {
    return(
        <section className="min-h-screen flex flex-col justify-center px-4 md:px-10 mb-6" id="contato">
